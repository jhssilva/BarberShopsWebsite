      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 m-auto text-center">
            ...
            <p>
              Find the best. We want you to find the best experience that you
              can possible have. Let's dive in together!
            </p>
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-lg-3 col-md-6">
            <div className="icon-box text-center">
              ...
              <div className="icon-box-title"></div>
